...
export default function Graph({ curriculo }) {
  ...
  useEffect(() => {
    ...
    async function inicializarGrafo() {
      try {
        ...
        const nodes = elementos.map((disc) => ({
          data: {
            id: disc.codigo,
            nome: disc.nome,
            ...
            ementa: disc.ementa,
            oldLabel: disc.codigo, // já define o label original
          },
        }));
        ...
        // exemplo: mudar todos os nós para azul
        cy.style()
          .selector("node")
          .style({
